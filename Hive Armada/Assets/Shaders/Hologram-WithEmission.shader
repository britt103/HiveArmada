Shader "SFHologram/HologramShader-WithEmission"
{
	Properties
	{
		// General
		...
		// Scanline
		_ScanTiling ("Scan Tiling", Range(0.01, 500.0)) = 0.05
	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				fixed4 eTexColor = tex2D(_EmissionTex, i.uv);
				...
				fixed4 col = texColor * eTexColor + (glow * 0.35 * _MainColor) + rimColor;
